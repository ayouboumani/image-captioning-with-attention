...
checkpoint_file = 'BEST_0checkpoint_foot_5_cap_per_img_5_min_word_freq.pth.tar'  # model checkpoint
...
def evaluate(beam_size):
    ...
    for i, (image_features, caps, caplens, allcaps) in enumerate(
        ...
        k= beam_size
        #check if the ref. caption is readable with the given word_map
        #if i==500:
           #break
        if 9487 in caps[0].tolist():
           #print('just deleted smt...') 
           deleted+=1
           # continue
        #print(caps[0])
        ...
        while True:
            ...
            #print('next_word_ind',next_word_inds)
            ...
            #print('incomplete inds',incomplete_inds)
            #print('complete ind', complete_inds)
    ...
    #print(len(hypotheses))
        ...
        #print('CIDEr metric ',compute_metric(references[0],hypotheses[0]))
