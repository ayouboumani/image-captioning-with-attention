...
def demo(beam_size):
    ...
    for image,image_features,name in zip(images,features,names):
        ...
        while True:
            ...
            attention_weighted_encoding = decoder.attention(image_features,h1)[0]
            alpha=decoder.attention(image_features,h1)[1]
            print(alpha)
        ...
        plt.text(0., len(image)+30, hypothesis, fontsize=12)
        plt.imshow(image)
        plt.axis('off')
